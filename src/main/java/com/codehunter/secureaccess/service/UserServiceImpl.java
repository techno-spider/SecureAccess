...
import com.codehunter.secureaccess.model.Role;
import com.codehunter.secureaccess.model.User;
import com.codehunter.secureaccess.repository.UserRepository;
...
public class UserServiceImpl implements UserService{
    ...
    public User save(UserRegistrationDto registrationDto) {
        ...
        User user = new User(registrationDto.getFirstName(),
                ...
                bCryptPasswordEncoder.encode(registrationDto.getPassword()), List.of(new Role("ROLE_USER")));
